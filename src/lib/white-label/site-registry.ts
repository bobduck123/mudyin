...
export const mudyinSiteConfig: WhiteLabelSiteConfig = {
  ...
  contact: {
    ...
    phone: '0478 796 298',
    routing: {
      general: 'info@mudyin.com',
      media: 'media@mudyin.com',
      partnership: 'partnerships@mudyin.com',
      program: 'programs@mudyin.com',
      volunteer: 'volunteer@mudyin.com',
    },
    address: {
